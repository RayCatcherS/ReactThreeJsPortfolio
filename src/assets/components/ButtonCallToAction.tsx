    ...
    return (
        <button
            ...
            className={`px-5 py-2.5 inline-block
                ...
                bg-violet-900 shadow-md transform transition-all duration-300 ease-out
                hover:bg-violet-700 hover:-translate-y-1.5 hover:scale-105 hover:shadow-[0_0_15px_rgba(139,92,246,0.5)]
